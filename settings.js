...
SETTINGS['watcha.com'] = {
  ...
  rootSelector: 'main',
  selector: 'ul>li>article[class*="-Cell"]>a>div, img[alt]',  //first: list item(parent of parent of IMG), second: large div on single page
  titleSelector: 'div[aria-hidden]>p, img[alt], h4[class]',  //order: list item, on large div, on main screen
  largeDivSelector: 'section>div>div.enter-done',  //parent of parent of parent of IMG (this is not for single page)
  specialSelector: {
    numberToParent: 2,
    selector: 'div',
  },
